export const lang = {
  ...
  en: {
    ...
    CONTACT: {
      TITLE: 'Contact',
      DESCRIPTION: 'If you have any questions or suggestions, email me at sohamtripathy811@gmail.com',
    ...
    FOOTER: {
      COPYRIGHT_START: '| ',
      COPYRIGHT_NAME: ['CC BY-SA 4.0', 'Am Logo Vectors by Vecteezy'],
      COPYRIGHT_LINK: ['https://creativecommons.org/licenses/by-sa/4.0/', 'https://www.vecteezy.com/free-vector/am-logo'],
      COPYRIGHT_END: ' |',
      COPYRIGHT_SEPARATOR: ' | '
    },
    ERROR: {
